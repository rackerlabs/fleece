...
- `--environments` an environments.yml file that defines the different environments and the associated AWS account for each. The format is as described in the `fleece run` command.
